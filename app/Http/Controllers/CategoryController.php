...
class CategoryController extends Controller
{
    ...
    {
        $data = new Category();
        $data->category_name = $request->get('nameCate');
        $data->save();
    ...
    {
        $objCategory = Category::find($id);
        $objCategory->category_name = $request->get('nameCate');
        $objCategory->save();
        return redirect()->route('categories.index')->with('status', 'Brand is Updated');
    }
